...
const Teams = ({ title, name }) => {
  return (
    <div className="px-3 flex items-center cursor-pointer rounded-lg border border-slate-300 shadow min-h-[100px] sm:flex dark:bg-gray-800 dark:border-gray-700 hover:bg-sky-50">
      <Image
